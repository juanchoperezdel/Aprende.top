              ...
              <div className="flex flex-col items-center justify-center mt-6">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <span className="text-xs text-gray-400 font-bold uppercase tracking-wider">Alumnas Verificadas</span>
                  </div>
                </div>
              </div>

              <p className="mt-4 text-[10px] text-gray-400 uppercase font-bold tracking-widest hidden">Garantía Incondicional de 7 Días</p>
            </div>
          </div>
        </div>
      </div>
